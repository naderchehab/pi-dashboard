...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactToggle = __webpack_require__(161);
	        ...
	        value: function handleChange() {
	            ...
	            _jquery2.default.ajax({
	                ...
	                success: function success(data) {
	                    if (data.success) {
	                        _this2.setState({ checked: data.state });
	                    } else {
	                        alert(data.error);
	                    }
	                }
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'label',
	                    null,
	                    _react2.default.createElement(_reactToggle2.default, { defaultChecked: this.state.checked, onChange: this.handleChange })
	                )
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var classNames = _interopRequire(__webpack_require__(162));

	var Check = _interopRequire(__webpack_require__(163));

	var X = _interopRequire(__webpack_require__(164));

	var PureRenderMixin = _interopRequire(__webpack_require__(165));
